          ...
          <>
            <div style={{ overflowX: 'auto' }}>
              <table className="data-table">
                <thead><tr>
                  <th>Name</th><th>Categories</th><th>Time</th><th>Servings</th><th>Giá/khẩu phần</th><th>Ingredients</th><th>Status</th><th>Average Rating</th><th style={{ textAlign: 'right' }}>Actions</th>
                </tr></thead>
                <tbody>
                  {items.map(r => (
                    <tr key={r.id}>
